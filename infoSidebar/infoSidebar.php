...
function postSidebar($conservationAreasToEcho) {
    ?>
    <ul>
        <li><?=get_the_date()?>
        <li>
            ...
            <ul>
                <?php foreach($conservationAreasToEcho as $conservationArea) echo "<li>$conservationArea</li>" ?>
            </ul>
        </li>
    </ul>
    <?php
...
postSidebar($conservationAreasAffected);